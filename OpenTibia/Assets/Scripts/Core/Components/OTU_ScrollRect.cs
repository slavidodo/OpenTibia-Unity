...
{
    [AddComponentMenu("UI/OTU Scroll Rect", 37)]
    [SelectionBase]
    [ExecuteAlways]
    ...
    /// </remarks>
    public class OTU_ScrollRect : UIBehaviour, IInitializePotentialDragHandler, IBeginDragHandler, IEndDragHandler, IDragHandler, IScrollHandler, ICanvasElement, ILayoutElement, ILayoutGroup
    {
        /// <summary>
