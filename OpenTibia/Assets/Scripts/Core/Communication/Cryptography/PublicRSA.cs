...
{
    internal class PublicRSA
    {
        internal const string OpenTibiaM = "";
        internal const string OpenTibiaE = "65537";
        ...
        internal const string RealTibiaE = "65537";

        internal const int RSABlockSize = 128;
