...
namespace OpenTibiaUnity.Modules.Skills
{
    public class SkillProgressPanel : SkillPanel
    {
        ...
        public override void SetValue(long value, float percent) => SetValuepublic(Core.Utils.Utility.Commafy(value), percent);

        private void SetValuepublic(string value, float percent) {
